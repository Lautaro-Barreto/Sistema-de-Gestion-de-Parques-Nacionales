...
#Descripci�n: Este script se encarga de testear la creaci�n de un tipo de visitante,
verificando que no se pueda crear un tipo de visitante con datos inv�lidos.
*/
