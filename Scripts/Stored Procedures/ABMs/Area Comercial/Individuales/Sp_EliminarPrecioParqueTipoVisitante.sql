...
#Descripción: Este script se encarga de la creación del Stored Procedure utilizado para eliminar una tarifa asociada a un tipo de visitante en un parque. 
*/
